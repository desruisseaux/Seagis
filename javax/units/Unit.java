...
import javax.units.resources.Quantities;
...
public abstract class Unit implements Serializable
{
    ...
    public static Unit get(final String symbol)
    {
        ...
        for (int i=0; i<3; i++)
        {
            ...
            if (unit instanceof Unit) return (Unit) unit;
        }
        return null;
    }
    ...
    public Unit pow(final int power) throws UnitException
    {
        switch (power)
        {
            ...
            case 1:  return this;
            default: throw new UnitException(Resources.format(ResourceKeys.BAD_UNIT_POWER_$2, new Integer(power), this), this, null);
        }
    }
    ...
    public Unit pow(final double power) throws UnitException
    {
        ...
        throw new UnitException(Resources.format(ResourceKeys.BAD_UNIT_POWER_$2, new Double(power), this), this, null);
    }
    ...
    {
        if (DerivedUnit.DIMENSIONLESS.equals(that)) return this;
     ...
     * d'exception pour ces unités. Toutes les classes du paquet <code>javax.units</code>
    ...
    {return new UnitException(Resources.format(ResourceKeys.BAD_UNIT_OPERATION_$2, this, that), this, that);}
    ...
    {return new UnitException(Resources.format(ResourceKeys.NON_CONVERTIBLE_UNITS_$2, this, that), this, that);}
