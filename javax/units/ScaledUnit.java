...
import javax.units.resources.Units;
 ...
 * entre différentes unités, par exemple des pieds en mètres. Cette classe n'ayant pas de
 * constructeur publique, la seule façon d'obtenir des unités proportionnelles est d'utiliser
 * les méthodes {@link #getInstance} ou {@link #scale}.
 *
 * @version 1.0
...
/*public*/ final class ScaledUnit extends Unit
{
    ...
    private ScaledUnit(final double amount, final SimpleUnit unit, final String symbol, final PrefixSet prefix)
    {
        ...
        if (Double.isNaN(amount) || Double.isInfinite(amount) || amount==0)
            throw new IllegalArgumentException(Resources.format(ResourceKeys.NOT_DIFFERENT_THAN_ZERO_$1, new Double(amount)));
    }
    ...
    public String getLocalizedName()
    {
        ...
        if (prefix!=null && symbol.endsWith(unpref))
        {
            ...
            if (p!=null) return p.getLocalizedName()+Units.localize(unpref);
        }
