 ...
 * La description du paquet <code>javax.units</code> donne une liste des préfix standards du
 * système SI.
 *
 * <p><em>Note: this class has a natural ordering that is inconsistent with equals.</em>
 * La méthode {@link #compareTo} ne compare que le champ {@link #amount}, tandis que la méthode
...
/*public*/ final class Prefix implements Comparable, Serializable
{
    ...
    {return javax.units.resources.Prefix.localize(name);}
    ...
    {
        if (object==this) return true; // slight optimisation
