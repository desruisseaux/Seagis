...
final class Observations extends AbstractMap<Parameter,Observation> implements Serializable {
     ...
     */
    private final fr.ird.animat.server.Parameter[] parameters;
     ...
     */
    public Observations(final fr.ird.animat.server.Parameter[] parameters, final float[] observations) {
    ...
    private final class Entry implements Map.Entry<Parameter, Observation>, Observation {
         ...
         */
        private final fr.ird.animat.server.Parameter parameter;
