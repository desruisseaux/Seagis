...
/**
 * Une fonction déterminant la position de la valeur minimale dans une région géographique. Cet
 ...
 * minimum a été trouvé.
 *
 * @version $Id$
 * @author Martin Desruisseaux
 */
public class MinimumEvaluator extends Evaluator {
    /**
     ...
     */
    public MinimumEvaluator(final GridCoverage coverage, final RectangularShape area) {
    ...
    /**
     * Trouve le minimum dans la région géographique spécifiée.
     *
    ...
    public double[] evaluate(final Shape area, double[] dest) {
        ...
        Arrays.fill(dest, 0, numBands, Double.POSITIVE_INFINITY);
        ...
        /*
         * Si certains minimums n'ont pas été trouvés, donne la valeur NaN.
         */
