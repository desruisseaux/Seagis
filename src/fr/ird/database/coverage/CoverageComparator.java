...
/**
 * Compare deux entrées {@link CoverageEntry} en fonction d'un critère arbitraire.
 ...
 */
public class CoverageComparator implements Comparator<CoverageEntry> {
    /**
     ...
     * du système de coordonnées de la table {@link CoverageTable} d'origine.
     */
    private final CoordinateSystem coordinateSystem;

    /**
     * Transformation permettant de passer du système de coordonnées
     * d'un objet {@link CoverageEntry} vers le système de coordonnées
     * de {@link CoverageTable} (c'est-à-dire {@link #coordinateSystem}).
     ...
     * qui avait été spécifiée à la table {@link CoverageTable}. Cette envelope
     ...
     */
    public CoverageComparator(final CoordinateSystem cs, final Envelope envelope) {
        int xDim = -1;
        int yDim = -1;
        int tDim = -1;
    ...
    /**
     * Compare deux objets {@link CoverageEntry}. Les classes dérivées peuvent
     ...
     */
    public int compare(final CoverageEntry entry1, final CoverageEntry entry2) {
     ...
     */
    protected Evaluator evaluator(final CoverageEntry entry) {
        try {
    ...
    protected class Evaluator {
         ...
         * {@link CoverageEntry} en cours de comparaison. Ces coordonnées doivent avoir
         * été transformées selon le système de coordonnées {@link #coordinateSystem}.
         */
