...
final class WritableGridCoverageTable extends GridCoverageTable {
     ...
     */
    private static final String SELECT_GEOMETRY = configuration.get(Configuration.KEY_GRID_GEOMETRIES);
     ...
     */
    private static final String SELECT_COVERAGE = configuration.get(Configuration.KEY_GRID_COVERAGES3);
    ...
    /**
     * The SQL instruction for inserting a new GridCoverage.
     */
    private static final String INSERT_GRID_COVERAGES_ID = configuration.get(Configuration.KEY_GRID_COVERAGES_ID_INSERT);
    
    /**
     * The SQL instruction for inserting a new GridCoverage.
     */
    private static final String INSERT_GRID_COVERAGES = configuration.get(Configuration.KEY_GRID_COVERAGES_INSERT);

    /**
     * The SQL instruction for inserting a new GridGeometry.
     */
    private static final String INSERT_GRID_GEOMETRIES_ID = configuration.get(Configuration.KEY_GRID_GEOMETRIES_ID_INSERT);

    /**
     * The SQL instruction for inserting a new GridGeometry.
     */
    private static final String INSERT_GRID_GEOMETRIES = configuration.get(Configuration.KEY_GRID_GEOMETRIES_INSERT);
            ...
            throws SQLException
    {
        ...
        if (insertArea == null) {
            insertArea = getConnection().prepareStatement(INSERT_GRID_GEOMETRIES);
        }       
        insertArea.setDouble(1, area.getMinX());
        insertArea.setDouble(2, area.getMaxX());
        insertArea.setDouble(3, area.getMinY());
        insertArea.setDouble(4, area.getMaxY());
        insertArea.setInt(5, size.width);
        insertArea.setInt(6, size.height);
