...
final class Species extends fr.ird.animat.server.Species {
     ...
     */
    public Species(final Locale[] locales, final String[] names, final Color color)
    ...
    public Species intern() {
        return (Species)pool.canonicalize(this);
    }

    /**
     * Après la lecture binaire, vérifie si l'espèce lue existait déjà en mémoire.
     */
