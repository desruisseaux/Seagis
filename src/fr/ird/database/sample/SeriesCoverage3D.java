...
/**
 * Valeurs d'une {@linkplain SeriesEntry série d'images} à des positions d'échantillons.
 * Cette couverture offre une méthode {@link #evaluate(SampleEntry,RelativePositionEntry,double[])
 * evaluate(...)} qui est capable d'adapter son calcul en fonction des données de l'échantillon.
 * Par exemple, le calcul pourrait se faire dans une région géographique dont la taille dépend de
