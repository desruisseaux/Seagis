 ...
 */
final class FormatEntry implements Entry, Serializable
{
    /**
     * Numéro de série (pour compatibilité avec des versions antérieures).
     */
    private static final long serialVersionUID = -5662019358956259227L;
     ...
     */
    protected FormatEntry(final int ID, final String name, final String mimeType, final String extension, final boolean geophysics, final CategoryList[] categories)
    {
        this.ID         = ID;
        this.name       = name.trim();
