...
final class RuleSimulationPane extends SimulationPane {
     ...
     */
    private final CatchLayer catchs;
    ...
    public RuleSimulationPane(final Simulation simulation) throws RemoteException {
        ...
        if (environment instanceof Fisheries) {
            catchs = new CatchLayer((Fisheries)environment);
            catchs.setTimeZone(timezone);
            mapPane.getRenderer().addLayer(catchs);
        } else {
            catchs = null;
        }
