 ...
 *
 * a set of isobaths forming a bathymetry ({@link fr.ird.map.layer.IsolineLayer}),
 * a remote sensing image ({@link fr.ird.map.layer.GridCoverageLayer}),
 * a set of arbitrary shapes marking locations ({@link fr.ird.map.layer.MarkLayer}),
 * a map scale ({@link fr.ird.map.layer.MapScaleLayer}), etc.
 * <br><br>
