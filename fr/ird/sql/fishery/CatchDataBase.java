 ...
 */
public class CatchDataBase extends DataBase
{
    /**
    ...
    {
        Table.logger.log(loadDriver(Table.preferences.get("Driver", "sun.jdbc.odbc.JdbcOdbcDriver")));
        return Table.preferences.get("Source", "jdbc:odbc:SEAS-Pêches");
    }
     ...
     */
    public CatchDataBase() throws SQLException
    {super(getDefaultURL(), TimeZone.getTimeZone("Indian/Reunion"));}
     ...
     */
    public CatchDataBase(final String name, final TimeZone timezone) throws SQLException
    {super(name, timezone);}
