 ...
 *       implementation.   We assume that <code>draw/fill</code> method invokes
 *       <code>getPathIterator(...)</code> only once,  and that the same flavor
...
final class ShapeBroker implements Shape, PathIterator
{
    ...
    /**
     * Construct a <code>ShapeBroker</code>
     ...
     * <code>false</code> before iteration can continue.
     */
     ...
     * <code>true</code> even if the underlying shape still has more points.
     */
    ...
    public PathIterator getPathIterator(final AffineTransform at, final double flatness)
    {
        ...
        if (iterator==null)
        {
            iterator = (isFlatnessSet) ? shape.getPathIterator(at, flatness) : shape.getPathIterator(at);
            flat = isFlatnessSet;
        }
        else
        {
    ...
    {if (!check) throw new IllegalPathStateException();}
}
