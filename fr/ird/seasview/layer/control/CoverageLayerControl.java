 ...
 */
public final class CoverageLayerControl extends LayerControl {
    /**
     * Objet à utiliser pour configurer l'affichage des images.
     */
    private transient CoverageControlPanel controler;

    /**
     * Construit une couche des images.
     */
    public CoverageLayerControl() {
        super(true);
    }
    ...
    protected void showControler(final JComponent owner) {
        ...
        synchronized (this) {
            if (controler == null) {
                controler = new CoverageControlPanel();
