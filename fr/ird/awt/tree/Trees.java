...
public final class Trees
{
     ...
     * constituée de noeuds {@link fr.ird.awt.tree.TreeNode} et comparera <code>value</code>
     * avec les objets retournés par la méthode {@link fr.ird.awt.tree.TreeNode#getUserObject}.
     * Les noeuds qui ne sont pas des objets {@link fr.ird.awt.tree.TreeNode} ne seront pas
     * comparés à <code>value</code>.
     *
     * @param  model Modèle dans lequel rechercher le chemin.
     * @param  value Objet à rechercher dans {@link fr.ird.awt.tree.TreeNode#getUserObject}.
    ...
    private static Object[] getPathsToUserObject(final TreeModel model, final Object value, Object[] path, final int length, final List<TreePath> list)
    {
        ...
        if (parent instanceof fr.ird.awt.tree.TreeNode)
        {
            final Object nodeValue = ((fr.ird.awt.tree.TreeNode) parent).getUserObject();
