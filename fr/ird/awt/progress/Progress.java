 ...
 * Cette classe est peut être utilisée à la place de {@link javax.swing.ProgressMonitor}, qui
 * n'offre pas les fonctionnalités désirées. La classe <code>Progress</code> ne suppose pas
 * que l'état d'avancement sera reporté dans une fenêtre. Par exemple {@link PrintProgress}
 * reporte l'état d'avancement sur le périphérique de sortie standard, ce qui est pratique
 * pour les programmes exécutés sur la ligne de commandes. Par exemple pour informer des
 * progrès de la lecture d'un fichier de 1000 lignes, ou pourrait écrire:
 *
 * <blockquote><pre>
 * &nbsp;Progress p=new {@link PrintProgress}();
 * &nbsp;p.setDecription("Lecture des données");
 * &nbsp;p.start();
 ...
 * multi-threads, et peuvent être exécutées dans n'importe quel thread. Ca implique en particulier qu'elles
 * peuvent être exécutées dans un thread autre que celui de <i>Swing</i>,  même si les progrès doivent être
...
public abstract class Progress
{
     ...
     */
    public abstract void warningOccurred(final String source, final String margin, final String warning);
     ...
     * Des arguments nuls sont acceptés.
     */
    static boolean equals(final Object a, final Object b)
    {return (a==b) || (a!=null && a.equals(b));}

    /**
     * Retourne une chaîne de caractères décrivant cet
     * objet. Cette chaîne sera de la forme suivante:
     *
