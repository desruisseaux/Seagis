 ...
 * flot. Le flot sera le plus souvent un écran de terminal comme la ligne de commandes DOS. L'avancement
 * de l'opération sera affiché en pourcentage sur une ligne (généralement le périphérique de sortie standard).
