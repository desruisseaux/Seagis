...
final class DynamicArray extends SubArray
{
     ...
     */
    private static final long serialVersionUID = -5963110930205135713L;
     ...
     */
    public PointArray insertAt(int index, final float toMerge[], final int mergeLower, final int mergeUpper, final boolean reverse)
    {
    ...
    public PointArray getFinal(final boolean compress)
    {
        ...
        if (points!=null) points=points.getFinal(compress);
        return points;
    }
