...
/**
 * Représentation graphique d'une grille de marque apparaissant sur une carte.  Cette classe
 * reprend les fonctionalités de {@link MarkLayer} en ajoutant la contrainte que les marques
 * doivent être disposées sur une grille régulière. Cette contrainte supplémentaire permet de:
 *
 * <ul>
...
public abstract class GridMarkLayer extends MarkLayer
{
    ...
    /**
     * Construit une grille de marques. Les coordonnées de ces
     ...
     *             coordonnées (<var>x</var>,<var>y</var>). Les indices <var>i</var> et <var>j</var> sont
     *             des entiers compris dans les plages <code>[0..width-1]</code> et <code>[0..height-1]</code>
     *             respectivement. Les coordonnées <var>x</var> et <var>y</var> sont des nombres réels exprimés
     *             selon le système de coordonnées spécifié lors de la construction ("WGS 1984" par défaut).
     */
     ...
     * de la région couverte par les points de la grille. Le point situé aux index (0,0) correspondra
     * au coin supérieur gauche de la région <code>area</code>. Appeller cette methode est équivalent
     * à appeller {@link #setGrid(Dimension, AffineTransform)} avec la transformation affine suivante:
     *
     * <blockquote><pre>
     * | dx/(width-1)      0           Xmin  |
     * |     0       -dy/(height-1)    Ymax  |
     ...
     * </pre></blockquote>
     *
     * où <var>dx</var> et <var>dy</var> sont les largeur et hauteur de <code>area</code> (en coordonnées
     * logiques), <var>X<sub>min</sub></var> et <var>Y<sub>max</sub></var> sont les coordonnées <var>x</var>
     ...
     *             selon le système de coordonnées spécifié lors de la construction
     *             ("WGS 1984" par défaut).
     */
