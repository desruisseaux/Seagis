 ...
 *
 * <p>&nbsp;</p>
 * <p align="center"><img src="{@docRoot}/doc-files/images/window/WindowProgress.gif"></p>
 * <p>&nbsp;</p>
 *
 * <p>Cette classe est conçue pour fonctionner correctement même si ses méthodes sont appellées
 * dans un autre thread que celui de <i>Swing</i>. Il est donc possible de faire la longue opération en arrière
...
public class WindowProgress extends Progress
{
    ...
    /**
     * Hauteur de la zone de texte qui contiendra
     ...
     */
    public WindowProgress(final Component parent)
    {
        /*
    ...
    private class Caller implements Runnable
    {
        ...
        public void run()
        {
            ...
            synchronized (WindowProgress.this)
            {
                ...
                {
                    final JInternalFrame window = (JInternalFrame) WindowProgress.this.window;
                    switch (task)
                    {
                        case   +TITLE: window.setTitle(text);     return;
                        case   -TITLE: text=window.getTitle();    return;
                ...
                if (warningArea==null)
                {
                    ...
                    WindowProgress.this.warningArea = warningArea;
                ...
                final JTextArea warningArea=(JTextArea) WindowProgress.this.warningArea;
