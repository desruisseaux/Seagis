 ...
 */
package net.seas.science.astro;
...
/**
 * Approximations de quelques calculs astronomiques relatifs à la Terre.
...
public final class Calendar
{
    ...
    /**
     * Retourne la longueur de l'année tropicale. L'année tropicale est définie comme l'intervalle moyen
     * entre deux équinoxes vernales (autour du 21 mars dans l'hémisphère nord). Il correspond au cycle
     * des saisons. Cet intervalle de temps est une <strong>moyenne</strong>. Un cycle réel peut s'écarter
     * de plusieurs minutes de cette moyenne. Notez aussi qu'une année tropicale n'est pas identique à
     * une année sidérale, qui est le temps requis par la Terre pour compléter un orbite autour du Soleil.
     * En l'an 2000, l'année tropicale avait une longueur d'environ 365,2422 jours tandis que l'année sidérale
     * avait une longueur de 365,2564 jours.
     */
    ...
    /**
     * Retourne la longueur du mois synodique. Le mois synodique est l'intervalle de temps moyen entre deux
     * conjonctions de la lune et du soleil. Il correspond au cycle des phases de la lune. Cet intervalle de
     * temps est une <strong>moyenne</strong>. Un cycle réel peut s'écarter de plusieurs heures de cette moyenne.
     */
