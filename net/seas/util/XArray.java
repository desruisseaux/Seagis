...
public final class XArray
{
    ...
    {return (Element[]) doResize(array, length);}
    ...
    {return (Element[]) doRemove(array, index, length);}
    ...
    {return (Element[]) doInsert(array, index, length);}
    ...
    {return (Element[]) doInsert(src, src_pos, dst, dst_pos, length);}
