...
/**
 * Rectangle à double-précision, haute-performance et enregistrable.  Au lieu d'utiliser les habituels champs
 * <code>x</code>, <code>y</code>, <code>width</code> et <code>height</code>, cette classe utilise des champs
 * {@link #xmin}, {@link #xmax}, {@link #ymin} et {@link #ymax}. Les méthodes telles que <code>contains</code>
 * et <code>intersects</code> y gagne en performance, ce qui rend cette classe plus appropriées que la classe
 * {@link Rectangle2D} standard pour une utilisation à l'intérieur d'une boucle.
 *
 * @version 1.0
...
{
    /** Coordonnées <var>x</var> minimale du rectangle. */ public double xmin;
    /** Coordonnées <var>y</var> minimale du rectangle. */ public double ymin;
    /** Coordonnées <var>x</var> maximale du rectangle. */ public double xmax;
    /** Coordonnées <var>y</var> maximale du rectangle. */ public double ymax;

    /**
     * Construit un rectangle par défaut. Les coordonnées
     ...
     * des coordonnées du rectangle spécifiée.
     */
