...
public class GridGeometry implements Dimensioned, Serializable
{
    ...
    public GridGeometry(final GridRange gridRange, final Envelope userRange, final boolean[] inverse)
    {
        ...
        {
            gridToCoordinateSystem2D = factory.createAffineTransform(new AffineTransform(scaleX, 0, 0, scaleY, transX, transY));
        }
        this.gridFromCoordinateSystem2D = inverse(gridToCoordinateSystem2D);
    }
    ...
    {
        if (gridToCoordinateSystem2D!=null) try
        {
...
------- END OF JDK 1.4 DEPENDENCIES ---*/
     ...
     * is given by {@link net.seagis.cv.Coverage#getCoordinateSystem}. If no math
    ...
    {
        if (gridFromCoordinateSystem2D!=null) try
        {
...
------- END OF JDK 1.4 DEPENDENCIES ---*/
    ...
    {
        if (bounds!=null && gridFromCoordinateSystem2D!=null) try
        {
            bounds = OpenGIS.transform(gridFromCoordinateSystem2D, bounds, null);
