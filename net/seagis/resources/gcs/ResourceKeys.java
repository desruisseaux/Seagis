...
public interface ResourceKeys
{
    ...
    public static final int ERROR_LINE_TOO_LONG_$3               =    39;
    public static final int ERROR_LINE_TOO_SHORT_$2              =    40;
    public static final int ERROR_MISMATCHED_ARRAY_LENGTH        =    41;
    public static final int ERROR_MISMATCHED_DIMENSION_$2        =    42;
    public static final int ERROR_NEGATIVE_COLUMN_$2             =    43;
    public static final int ERROR_NOT_A_GRID                     =    44;
    public static final int ERROR_NO_IMAGE_INPUT                 =    45;
    public static final int ERROR_NO_IMAGE_READER                =    46;
    public static final int ERROR_NO_TRANSFORM2D_AVAILABLE       =    47;
    public static final int ERROR_NULL_FORMAT_$2                 =    48;
    public static final int ERROR_NUMBER_OF_BANDS_MISMATCH_$2    =    49;
    public static final int ERROR_OPERATION_ALREADY_BOUND_$1     =    50;
    public static final int ERROR_OPERATION_NOT_FOUND_$1         =    51;
    public static final int ERROR_PARSE_EXCEPTION_$2             =    52;
    public static final int ERROR_POINT_OUTSIDE_COVERAGE_$1      =    53;
    public static final int ERROR_RANGE_OVERLAP_$4               =    54;
    public static final int ERROR_RGB_OUT_OF_RANGE_$1            =    55;
    public static final int ERROR_UNDEFINED_PROPERTY             =    56;
    public static final int ERROR_UNDEFINED_PROPERTY_$1          =    57;
    public static final int ERROR_UNEXPECTED_IMAGE_SIZE          =    58;
    public static final int ERROR_UNKNOW_INTERPOLATION_$1        =    59;
    public static final int ERROR_UNKNOW_PARAMETER_NAME_$1       =    60;
    public static final int ERROR_UNPARSABLE_NUMBER_$1           =    61;
    public static final int ERROR_UNSPECIFIED_COORDINATE_SYSTEM  =    62;
    public static final int ERROR_UNSPECIFIED_IMAGE_SIZE         =    63;
    public static final int ERROR_UNSUPPORTED_DATA_TYPE          =    64;
}
