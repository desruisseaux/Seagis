...
public interface ResourceKeys
{
    ...
    public static final int MTM_PROJECTION                              =    25;
    ...
    public static final int UTM_PROJECTION                              =    40;
    ...
    public static final int ERROR_ILLEGAL_ANGLE_PATTERN_$1              =    48;
    public static final int ERROR_ILLEGAL_ARGUMENT_$2                   =    49;
    public static final int ERROR_ILLEGAL_ARRAY_LENGTH_FOR_DIMENSION_$1 =    50;
    public static final int ERROR_ILLEGAL_AXIS_ORIENTATION_$2           =    51;
    public static final int ERROR_ILLEGAL_CS_DIMENSION_$1               =    52;
    public static final int ERROR_ILLEGAL_ENVELOPE_ORDINATE_$1          =    53;
    public static final int ERROR_INCOMPATIBLE_ELLIPSOID_$2             =    54;
    public static final int ERROR_INDEX_OUT_OF_BOUNDS_$1                =    55;
    public static final int ERROR_LATITUDE_OUT_OF_RANGE_$1              =    56;
    public static final int ERROR_LONGITUDE_OUT_OF_RANGE_$1             =    57;
    public static final int ERROR_MATRIX_NOT_REGULAR                    =    58;
    public static final int ERROR_MISMATCHED_DIMENSION_$2               =    59;
    public static final int ERROR_MISSING_PARAMETER_$1                  =    60;
    public static final int ERROR_NONINVERTIBLE_TRANSFORM               =    61;
    public static final int ERROR_NON_ANGULAR_UNIT_$1                   =    62;
    public static final int ERROR_NON_LINEAR_UNIT_$1                    =    63;
    public static final int ERROR_NON_TEMPORAL_UNIT_$1                  =    64;
    public static final int ERROR_NOT_AN_AFFINE_TRANSFORM               =    65;
    public static final int ERROR_NOT_AN_ANGLE_OBJECT_$1                =    66;
    public static final int ERROR_NOT_TWO_DIMENSIONAL_$1                =    67;
    public static final int ERROR_NO_CONVERGENCE                        =    68;
    public static final int ERROR_NO_DESTINATION_AXIS_$1                =    69;
    public static final int ERROR_NO_TRANSFORMATION_PATH_$2             =    70;
    public static final int ERROR_NO_TRANSFORM_FOR_CLASSIFICATION_$1    =    71;
    public static final int ERROR_NULL_ARGUMENT_$1                      =    72;
    public static final int ERROR_PARSE_ANGLE_EXCEPTION_$2              =    73;
    public static final int ERROR_POLE_PROJECTION_$1                    =    74;
    public static final int ERROR_UNMODIFIABLE_AFFINE_TRANSFORM         =    75;
    public static final int ERROR_VALUE_TEND_TOWARD_INFINITY            =    76;
}
