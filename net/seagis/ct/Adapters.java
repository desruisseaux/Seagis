...
public class Adapters
{
    ...
    /**
     * The underlying adapters from the <code>net.seagis.cs</code> package.
     */
    public final net.seagis.cs.Adapters CS;

    /**
     * The underlying adapters from the <code>net.seagis.pt</code> package.
     */
    public final net.seagis.pt.Adapters PT;
     ...
     * Default constructor.
     *
     * @param CS The underlying adapters from the <code>net.seagis.cs</code> package.
     */
    protected Adapters(final net.seagis.cs.Adapters CS)
    {
        this.CS = CS;
        this.PT = CS.PT;
    }
    ...
    public static synchronized Adapters getDefault()
    {
        if (DEFAULT==null)
        {
            DEFAULT = new Adapters(net.seagis.cs.Adapters.getDefault());
        }
        return DEFAULT;
    }
    ...
    public MathTransform wrap(final CT_MathTransform transform) throws RemoteException
    {
        ...
        else return new MathTransformAdapter(transform);
    }
