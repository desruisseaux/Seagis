...
// Resources
import net.seagis.resources.Colors;
...
public class PaletteFactory
{
    ...
    private IndexColorModel getIndexColorModel(final String name, final int lower, final int upper) throws IOException
    {
        ...
        final int[] ARGB = new int[1 << Colors.getBitCount(upper)];
        Colors.expand(colors, ARGB, lower, upper);
        return Colors.getIndexColorModel(ARGB);
    }
    ...
    private static int byteValue(final int value) throws ParseException
    {
        ...
        throw new ParseException(Resources.format(ResourceKeys.ERROR_RGB_OUT_OF_RANGE_$1, new Integer(value)), 0);
    }
}
