...
public class PropertyParser
{
     ...
     * @throws RasterFormatException if a property is defined twice.
     */
    public synchronized void add(final PropertySource properties, final String prefix) throws RasterFormatException
     ...
     * @throws RasterFormatException if a property is defined twice.
     */
    private void add(final PropertySource properties, final String[] names) throws RasterFormatException
    {
        if (names!=null)
        {
            for (int i=0; i<names.length; i++)
...
//----- END OF JDK 1.3 FALLBACK -------
        ...
        {
            throw new RasterFormatException(Resources.getResources(locale).getString(ResourceKeys.ERROR_DUPLICATED_PROPERTY_$1, key));
        }
    ...
    public final Object get(final String key) throws NoSuchElementException
    {
        ...
        throw new NoSuchElementException(Resources.getResources(locale).getString(ResourceKeys.ERROR_UNDEFINED_PROPERTY_$1, key));
    }
     ...
     */
    public double getAsDouble(final String key) throws NoSuchElementException, NumberFormatException
    {
     ...
     */
    public int getAsInt(final String key) throws NoSuchElementException, NumberFormatException
    {
        final Object value = get(key);
        if (value instanceof Number)
        {
...
//----- END OF JDK 1.3 FALLBACK -------
    ...
    public synchronized Projection getProjection() throws NoSuchElementException
    {
        ...
        if (!semiMajorAxisDefined || !semiMinorAxisDefined)
        {
            ...
            {
                throw new RasterFormatException(Resources.getResources(locale).getString(ResourceKeys.ERROR_AMBIGIOUS_AXIS_LENGTH));
            }
    ...
    public synchronized CoordinateSystem getCoordinateSystem() throws NoSuchElementException
    {
        if (coordinateSystem==null)
        {
            ...
            gcs = factory.createGeographicCoordinateSystem(text, geoUnits, datum, meridian, AxisInfo.LONGITUDE, AxisInfo.LATITUDE);
            if (isGeographic)
            {
            ...
            {
                coordinateSystem = factory.createProjectedCoordinateSystem(text, gcs, getProjection(), units, AxisInfo.X, AxisInfo.Y);
            }
        }
