...
public class Adapters
{
    ...
    /**
     * The underlying adapters for the <code>net.seagis.pt</code> package.
     */
     ...
     * Default constructor.
     *
     * @param PT The underlying adapters for <code>net.seagis.pt</code> package.
     */
    protected Adapters(final net.seagis.pt.Adapters PT)
    {this.PT = PT;}
    ...
    public static synchronized Adapters getDefault()
    {
        if (DEFAULT==null)
        {
            DEFAULT = new Adapters(net.seagis.pt.Adapters.getDefault());
        }
        return DEFAULT;
    }
    ...
    public Ellipsoid wrap(final CS_Ellipsoid ellipsoid) throws RemoteException
    {
        ...
        return new Ellipsoid(map(ellipsoid),
    ...
    public HorizontalDatum wrap(final CS_HorizontalDatum datum) throws RemoteException
    {
        ...
        return new HorizontalDatum(map(datum), wrap(datum.getDatumType()),
                                   wrap(datum.getEllipsoid()), wrap(datum.getWGS84Parameters()));
    }
